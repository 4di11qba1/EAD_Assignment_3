...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void submitBTN_Click_1(object sender, EventArgs e)
        {
            ...
            string clearCourse = clear == true ? "Pre Requisite Cleared" : "Pre Requisite Not Cleared";
            string multiLineTextbook = $"First Name: {firstName}\nLast Name: {lastName}\nCourse Selected: {course}\nPre Requisite: {clearCourse}";
            task2List.Add(multiLineTextbook);

            string Submission = $"First Name: {firstName}\nLast Name: {lastName}\nCourse Selected: {course}\nPre Requisite: {clearCourse}";
